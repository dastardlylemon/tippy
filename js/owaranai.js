...
(function() {
  var addsubDate, days, defaultRanking, format, getDate, getMonth, loadImages, loadOptions, months, populateTabList, randomize, saveOptions, startTime, truncate, workmode;

  randomize = function(arr) {
    var curIndex, randIndex, results, tempVal;
    curIndex = arr.length;
    results = [];
    while (0 !== curIndex) {
      ...
      results.push(arr[randIndex] = tempVal);
    }
    return results;
  };
